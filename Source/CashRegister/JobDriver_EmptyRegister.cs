...
namespace CashRegister
{
	public class JobDriver_EmptyRegister : JobDriver
	{
		...
		public override IEnumerable<Toil> MakeNewToils()
		{
			...
			yield return Toils_Goto.GotoThing(IndexRegister, PathEndMode.Touch).FailOnDestroyedOrNull(IndexSilver);
            yield return Toils_General.Do(GetSilver).FailOnDestroyedOrNull(IndexSilver);
		...
		private void Haul()
		{
			...
			{
				var haulJob = HaulAIUtility.HaulToStorageJob(pawn, Silver, false); //added false
				if (haulJob != null)
				{
